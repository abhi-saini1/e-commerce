  ...
  return (
    <section className="py-20">
      <div className="main-container">
        <div className="bg-gray-300 rounded-lg w-full h-full   lg:flex items-center justify-center lg:justify-between p-5  sm:flex sm:items-center sm:justify-center">
          {/* Contact text */}
          ...
          {/* Contact Form */}
          <div className=" w-[300px] bg-white rounded-lg h-full m-5 p-3 lg:w-[600px]">
                <div className="m-2">
                    ...
                    <form>
                        <div className="lg:flex items-center justify-between my-5 ">
                            <div className="flex flex-col">
                                ...
                                <input type="text" id="name" className="border border-gray-400 text-black w-[250px] h-10 rounded m-1" />
                            </div>
                            <div className="flex flex-col">
                            <label className="text-[14px] font-medium">Company</label>
                            <input type="text" id="Company"   className="border border-gray-400 text-black w-[250px] h-10 rounded m-1" />
                            </div>
                        ...
                        <div className="lg:flex items-center justify-between my-5 ">
                            <div className="flex flex-col">
                                ...
                                <input type="email" id="name" className="border border-gray-400 text-black w-[250px] h-10 rounded m-1" />
                            </div>
                            <div className="flex flex-col">
                            <label className="text-[14px] font-medium">Phone No</label>
                            <input type="number" id="Company"   className="border border-gray-400 text-black w-[250px] h-10 rounded m-1" />
                            </div>  
                        </div>
                        <div className="flex flex-col my-5">
                            <label className="text-[14px] font-medium">Message</label>
                            <textarea  className=" m-1 border border-gray-400 text-black rounded" placeholder="Type your message here" cols={10} rows={8}/>
                        </div>
